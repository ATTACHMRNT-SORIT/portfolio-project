    ...
    <body>
        ...
        <header class="header" id="header">
          <nav class="nav container">
            <a href="#" class="nav__logo">Kevin</a>
        ...
        <main class="main">
            ...
            <section class="home section" id="home">
              <div class="home__container container grid">
                <div class="home__data">
                  ...
                  <h1 class="home__name">Kevin Klee</h1>
                  <h3 class="home__education">Frontend Developer</h3>
      
                  <div class="home__buttons">
                    <a
                      download=""
                      href="assets/pdf/Kevin-Cv.pdf"
                ...
                <div class="home__handle">
                  <img src="assets/img/about.png" alt="perfill" class="home__img" />
                </div>
                ...
                <div class="home__social">
                  ...
                  <a
                    href="https://github.com/javokhirabdullakhonov"
                    class="home__social-link" target='_blank'
                  >
                    <i class="bx bxl-github"></i>
                  </a>
                  <a
                    href="https://instagram.com/javokhirweb7"
                    class="home__social-link" target='_blank'
                  >
            ...
            <section class="about section" id="about">
              ...
              <div class="about__container container grid">
                <img src="assets/img/perfil.png" alt="about img" class="about__img" />
            ...
            <section class="work section" id="work">
              ...
              <div class="work__container container grid">
                <div class="work__card mix web">
                  <img src="assets/img/work1.jpg" alt="work 1" class="work__img" />
                ...
                <div class="work__card mix movil">
                  <img src="assets/img/work2.jpg" alt="work 1" class="work__img" />
                ...
                <div class="work__card mix design">
                  <img src="assets/img/work3.jpg" alt="work 1" class="work__img" />
                ...
                <div class="work__card mix web">
                  <img src="assets/img/work4.jpg" alt="work 1" class="work__img" />
                ...
                <div class="work__card mix movil">
                  <img src="assets/img/work5.jpg" alt="work 1" class="work__img" />
                ...
                <div class="contact__content">
                  ...
                  <div class="contact__info">
                    ...
                    <div class="contact__card">
                      ...
                      <span class="contact__card-data">+1234567890</span>
      
                      <a href="https://t.me/" target="_blank" class="contact__button">
                        Write me
                        <i class="bx bx-right-arrow-alt contact__button-icon"></i>
                      </a>
